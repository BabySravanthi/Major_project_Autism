...
def login():
    if request.method == 'POST':
        ...
        if username == "autism" and password == "patient":
...
def modelselection():
    ...
    if request.method=='POST':
        ...
        if model == '1':
            ...
            msg = 'The accuracy of DecisionTreeClassifier:'+str(DTaccuracy)
            print("=====",DTaccuracy,"====")
            return render_template('dt.html',msg=msg)
        elif model=='2':
            print('xxxxxxxxxxx')
            lr = XGBClassifier()
            ...
            msg = 'The accuracy of RandomForestClassifier:'+str(RFaccuracy)
            return render_template('rf.html',msg=msg)
        elif model=='4':
            ...
            msg = 'The accuracy of GaussianNB:'+str(gnbaccuracy)
            return render_template('gnb.html',msg=msg)
        elif model=='8':
